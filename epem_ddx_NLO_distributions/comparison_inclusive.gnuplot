...
#
################################################################################
# /Users/valentin/Documents/MG5/2.6.6/madgraph/various/histograms.py epem_ddx_NLO_MG5aMC_distributions.HwU Jet1PT_combined.HwU --titles=j1 pT --out=comparison
reset
...
set key font ",9"
set key samplen "2"
set output "comparison_inclusive.ps"
...
set format y '10^{%T}'
set yrange [0.50e+00:1.0244e+04]
...
plot \
'comparison_inclusive.HwU' index 5 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)):4 w yerrorbar ls 103 title '',\
'comparison_inclusive.HwU' index 5 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)) ls 103 title '',\
'comparison_inclusive.HwU' index 5 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3):4 w yerrorbar ls 3 title '',\
'comparison_inclusive.HwU' index 5 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3) ls 3 title 'NLO alphaLoop, central value',\
'comparison_inclusive.HwU' index 4 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)):4 w yerrorbar ls 102 title '',\
'comparison_inclusive.HwU' index 4 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)) ls 102 title '',\
'comparison_inclusive.HwU' index 4 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3):4 w yerrorbar ls 2 title '',\
'comparison_inclusive.HwU' index 4 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3) ls 2 title 'LO, central value',\
'comparison_inclusive.HwU' index 3 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)):4 w yerrorbar ls 101 title '',\
'comparison_inclusive.HwU' index 3 using (($1+$2)/2):($3 >= 0 ? 1.0e-9 : abs($3)) ls 101 title '',\
'comparison_inclusive.HwU' index 3 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3):4 w yerrorbar ls 1 title '',\
'comparison_inclusive.HwU' index 3 using (($1+$2)/2):($3 < 0 ? 1.0e-9 : $3) ls 1 title 'NLO, central value'
#-- rendering subhistograms 'Relative scale and PDF uncertainty'
unset label
unset format
set yrange [-0.014:0.014]
...
plot \
0.0 ls 999 title '',\
'comparison_inclusive.HwU' index 5 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 3 title '',\
'comparison_inclusive.HwU' index 4 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 2 title '',\
'comparison_inclusive.HwU' index 3 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 1 title ''
#-- rendering subhistograms '(LONLO alphaLoop)/(NLO central value) ratio'
unset label
unset format
set yrange [0.9:1.09]
...
set label "(LONLO alphaLoop)/(NLO central value)" font ",9" at graph 0.03, graph 0.13
plot \
1.0 ls 999 title '',\
0.99 ls 999 title '',\
1.01 ls 999 title '',\
'comparison_inclusive.HwU' index 7 using (($1+$2)/2):3:4 w yerrorbar ls 3 title '',\
'comparison_inclusive.HwU' index 7 using (($1+$2)/2):3 ls 3 title '',\
'comparison_inclusive.HwU' index 6 using (($1+$2)/2):3:4 w yerrorbar ls 2 title '',\
'comparison_inclusive.HwU' index 6 using (($1+$2)/2):3 ls 2 title ''

unset label

################################################################################
unset multiplot
!ps2pdf "comparison_inclusive.ps" &> /dev/null
!open "comparison_inclusive.pdf" &> /dev/null
