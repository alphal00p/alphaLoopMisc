...
&&
+ \int d^{4-2\epsilon}k\; \textrm{UVCT}(k,p){\Big |}_{d=4-2\epsilon, p^2=m_p^2 }  -\textrm{R-terms}|_{p^2=m_p^2}  \nonumber \\
...
&&
+ \int d^{4-2\epsilon}k\; \textrm{UVCT}(k,p){\Big |}_{d=4-2\epsilon, p^2=m_p^2 }  -\textrm{R-terms}|_{p^2=m_p^2}  \nonumber \\
&\rightarrow& \Delta \textrm{UV}_\psi = -\textrm{R-terms}|_{p^2=m_p^2}  + \left[
...
\begin{eqnarray}
\frac{\partial}{\partial k^0} \overline{\Sigma}_{ij}(p)
...
\end{eqnarray}
where  $\int \tilde{d}k\; \equiv \left(\frac{\mu^2}{4\pi e^{-\gamma}}\right)^{\epsilon} \int \frac{d^{4-2\epsilon}k}{(2\pi)^{-2\epsilon}} $ (the additional factor $ \left(\frac{1}{4\pi e^{-\gamma}}\right)^{\epsilon} $ is designed so as to automatically reabsorb the terms removed by finite part of the $\overline{\textrm{MS}}$ renormalisation counterterms). 
...
\begin{equation}
\int \frac{\tilde{d} k}{(2\pi)^d} \frac{ k^2 }{\left[ k^2+M^2\right]^a} =\frac{(M^2)^{\frac{d}{2}-a}}{(4\pi)^\frac{d}{2}}\frac{\Gamma(a-\frac{d}{2})}{\Gamma(a)}
\end{equation}
we find:
\begin{eqnarray}
...
\begin{eqnarray}
A_{R_1}&=& \frac{1}{d} \int \frac{\tilde{d} k}{(2\pi)^4} \frac{ \tilde{k}^2 }{\left[ \bar{k}^2+M_\textrm{UV}^2\right]^3} \nonumber \\
A_{R_2} &=& \frac{1}{d} \int \frac{\tilde{d} k}{(2\pi)^4} \frac{ \bar{k}^2 Z^3 - k^2 }{\left[ k^2+M_\textrm{UV}^2\right]^3}
...
we find:
\begin{eqnarray}
A_{R_1} &=&-\frac{1}{4}\frac{1}{2}\frac{1}{16 \pi^2} = -\frac{1}{128 \pi^2} \nonumber\\
A_{R_2} &=& -\frac{3}{4}\frac{1}{3}\frac{1}{16 \pi^2} = -\frac{1}{64 \pi^2}.
\end{eqnarray}
Recalling the definition of $\Delta \textrm{UV}_\psi$ from~\eqref{eq:DeltaUVpsidef}:
\begin{equation}
\Delta \textrm{UV}_\psi = -\textrm{R-terms}|_{p^2=m_p^2}  + \left[
\frac{\partial}{\partial p^0} \int d^{4-2\epsilon}k\; \textrm{UVCT}(k,p){\Big |}_{d=4-2\epsilon, p^2=m_p^2 }
- \gamma^0 \delta Z_\psi
\right ],
\end{equation}
...
The correct result must instead be a pre-factor of $\frac{1}{3}$ which would nicely yield $97$ [pb].
