c
c Example analysis for "!a! !a! > c c~ [QCD]" process.
c
...
c      data cc/'|T@NLO','|T@LO '/
     ...
     $     ' |T@LO1      ',' |T@NLO1     ', ' |T@NLO2     '/
      ...
      do i=1,6
         ...
         call HwU_book(l+ 2,'c rap         '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 3,'cx rap        '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 4,'c-cx pair rap '//cc(i), 100,-5d0,5d0)
         call HwU_book(l+ 5,'m c-cx        '//cc(i),100,0d0,100d0)
         call HwU_book(l+ 6,'pt c          '//cc(i),100,0d0,40d0)
         call HwU_book(l+ 7,'pt cx         '//cc(i),100,0d0,40d0)
         call HwU_book(l+ 8,'pt c-cx       '//cc(i),100,0d0,20d0)
      enddo
      return
      end
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &        /'only for process "!a! !a! > c c~ [QCD QED]"'
         stop 1
      endif
