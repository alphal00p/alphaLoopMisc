...
#*********************************************************************
  82    = nb_proton1 # number of proton for the first beam
  126   = nb_neutron1 # number of neutron for the first beam
...
#***********************************************************************
 ...
 4.75   = muR_ref_fixed    ! fixed ren reference scale
 4.75   = muF_ref_fixed    ! fixed fact reference scale
...
all_energies="1000 2000 2760 3000 3150 4000 5000 5120 5360 5520 6000 7000 8000 9000 10000 11000 12000 13000 14000 15000 16000 17000 18000 19000 20000 24000 30000 39400 40000 50000 60000 70000 80000 90000 100000"

for zenergy in $all_energies
do
    tenergy=$(calc $zenergy/1000)
    echo "INFO: run a PbPb job at energy=$tenergy TeV"
    benergy=$(calc $zenergy/2*208)
    #echo $benergy
    #continue
