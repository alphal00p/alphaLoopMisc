c
c Example analysis for "!a! !a! > b b~ [QCD]" process.
c
...
c      data cc/'|T@NLO','|T@LO '/
     ...
     $     ' |T@LO1      ',' |T@NLO1     ', ' |T@NLO2     '/
      ...
      do i=1,6
         ...
         call HwU_book(l+ 2,'b rap         '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 3,'bx rap        '//cc(i), 50,-5d0,5d0)
         call HwU_book(l+ 4,'b-bx pair rap '//cc(i), 100,-5d0,5d0)
         call HwU_book(l+ 5,'m b-bx        '//cc(i),100,0d0,100d0)
         call HwU_book(l+ 6,'pt b          '//cc(i),100,0d0,40d0)
         call HwU_book(l+ 7,'pt bx         '//cc(i),100,0d0,40d0)
         call HwU_book(l+ 8,'pt b-bx       '//cc(i),100,0d0,20d0)
      enddo
      return
      end
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &        /'only for process "!a! !a! > b b~ [QCD QED]"'
         stop 1
      endif
     ...
     &        /'only for process "!a! !a! > b b~ [QCD QED]"'
      ...
      if (.not. (ipdg(5).eq.22.or. ipdg(5).eq.21)) then
