...
rr = {p1 -> (Rationalize[#,10^-32]&/@{1, 0, 0, 1}),
p2 -> (Rationalize[#,10^-32]&/@{-1, 0., 0., 1.}),
q1 -> (Rationalize[#,10^-32]&/@{0.,2.3,0.2,1.1}),
q2 -> (Rationalize[#,10^-32]&/@{0.,0.2,1.3,3.123})};
...
setTo0 ={1->1};(* {xZenoConst1 ->0, xZenoConst2 ->0, xZenoConst4->0,xZenoConst5 ->0} *);
...
test1 = StringReplace[#,{"["->"(","]"->")"}]&@(ToString[#,InputForm]&@(numerator/. setTo0 /. rrZenoToAndrea /. andrea /. Dot->sp /. m1 ->sp[q1,q1] /. m2 -> sp[q2,q2] /. m3 -> sp[q3,q3] /. q1->p3 /. q2->p4 /. q3 ->p5 /. k3 ->p4 /. k2 -> p3//Simplify)) ;
