...
static double complex diag_4(double complex lm[], double complex params[]) {
	...
	double complex invd1 = 1./(lm[36]+lm[23]+E3+E1);
	double complex invd2 = 1./(lm[36]+E3+E2);
	double complex invd3 = 1./(-lm[36]-lm[23]-lm[8]+lm[5]+lm[0]+E5+E4);
	double complex invd4 = 1./(lm[36]+lm[23]+lm[8]-lm[5]-lm[0]+E5+E4);
	double complex invd5 = 1./(-lm[36]+lm[5]+E2+E0);
	double complex invd6 = 1./(lm[23]+E2+E1);
	double complex invd7 = 1./(-lm[36]+E3+E2);
	double complex invd8 = 1./(-lm[36]-lm[23]+lm[5]+E1+E0);
	double complex invd9 = 1./(-lm[23]+E2+E1);
	double complex invd10 = 1./(-lm[36]-lm[23]+E3+E1);
	double complex invd11 = 1./(lm[36]+lm[23]-lm[5]+E1+E0);
	double complex invd12 = 1./(lm[36]-lm[5]+E2+E0);
	double complex invd13 = 1./(-lm[5]+E3+E0);
	...
	return pow(2.*pi*I,2)/(2.*E0*2.*E1*2.*E2*2.*E3*2.*E4*2.*E5)*(Z10_ + Z11_);
}
...
static double complex diag_2(double complex lm[], double complex params[]) {
	double complex Z10_,Z11_,Z12_,Z13_,Z14_,Z15_,Z16_,Z17_;
	double complex E0 = sqrt(lm[53]+1e-08);
	double complex E1 = sqrt(lm[53]-2*lm[51]+2*lm[44]+lm[42]-2*lm[40]+2*lm[33]+2*lm[31]+lm[29]-2*lm[27]+lm[7]+1e-08);
	double complex E2 = sqrt(lm[53]-   2*lm[51]+2*lm[44]+lm[42]-2*lm[40]+lm[7]+1e-08);
	double complex E3 = sqrt(lm[53]-2*lm[51]+lm[7]+1e-08);
...
static inline void evaluate_PF_1_0(double complex lm[], double complex params[], double complex* out) {
	double complex Z10_,Z11_,Z12_,Z13_,Z14_,Z15_,Z16_,Z17_,Z18_,Z19_,Z20_,Z21_,Z22_;
