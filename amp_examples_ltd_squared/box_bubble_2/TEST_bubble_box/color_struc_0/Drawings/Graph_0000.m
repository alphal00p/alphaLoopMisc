...
Labeled[Style[CreateEdge["10","3",5],Gray,Thickness[0.002000]],"psis|pq3|k1+k2+k3+k4-p1-p2"],
...
Labeled[Style[CreateEdge["10","9",12],Gray,Thickness[0.002000]],"psis|pq10|-k3-k4-k5+p1+p2"]
},
EdgeShapeFunction -> {
...
CreateEdge["10","9",12]->GraphElementData["Arrow", "ArrowSize" -> 0.015000]
},
