...
SetAttributes[v,Orderless];
   ...
   prop[q[ p_,{n_,m_}]] := ii*delta[sunF[n], sunF[m]]*gamma[s[n], mu[n, m], s[m]]*vector[p, mu[n, m]]scalarProp[p,0];
   ...
   v[gluon[p1_,i1_], gluon[p2_,i2_], gluon[p3_,i3_], gluon[p4_,i4_]] :> gs^2*ii*(f[sunA[i1], sunA[i2], sunA[i1, i2, i3, i4]]*f[sunA[i3], sunA[i4], sunA[i1, i2, i3, i4]] *(g[mu[i1], mu[i4]]*g[mu[i2], mu[i3]] - 
      ...
      (g[mu[i1], mu[i3]]*g[mu[i2], mu[i4]] - g[mu[i1], mu[i2]]*
       g[mu[i3], mu[i4]]));
   (* g q qbar *) 
   v[gluon[p3_,i3_], q[p2_,i2_], qbar[p1_,i1_]] := gs*ii*gamma[s[i1], mu[i3], s[i2]]*T[sunA[i3], sunF[i1], sunF[i2]];
   (* gamma q qbar *) 
   v[photon[p3_,i3_], q[p2_,i2_], qbar[p1_,i1_]] := 2/3 ee*ii*gamma[s[i1], mu[i3], s[i2]] delta[sunF[i1],sunF[i2]];
   (*eplus eminus gamma*)      
